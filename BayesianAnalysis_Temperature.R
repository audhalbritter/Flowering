...
#glmer
fit <- glmer(cbind(SumOffertile, NumberOfOccurrence - SumOffertile) ~ MeanSummerTempGrid.sc + MeanSummerTempAnnomalie.sc + AnnPrecGrid.sc + AnnPrecAnnomalie.sc + MeanSummerTempPrevAnnomalie.sc + AnnPrecPrevAnnomalie.sc + (1|species) + (1|siteID) + (1|year), data = Dat, family = "binomial")
summary(fit)

fit <- glmer(cbind(SumOffertile, NumberOfOccurrence - SumOffertile) ~ MeanSummerTempGrid.sc + MeanSummerTempAnnomalie.sc + AnnPrecGrid.sc + AnnPrecAnnomalie.sc + MeanSummerTempPrevAnnomalie.sc + AnnPrecPrevAnnomalie.sc 
...
para.names <- c("alpha", "betaClimateT", "betaWeatherT", "betaClimateP", "betaWeatherP", "betaWeatherPrevT", "betaWeatherPrevP", "betaCWT", "betaCWP", "betaCTCP")
...
res1 <- jags(data = Data,
             ...
             n.cores = 3)
plot(res1)
whiskerplot(res1, c("betaClimateT", "betaWeatherT", "betaClimateP", "betaWeatherP", "betaWeatherPrevT", "betaWeatherPrevP", "betaCWT", "betaCWP", "betaCTCP"))
res1
names(res1)
res1$summary
